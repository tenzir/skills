...
canonical: https://tenzir.com/docs/guides/store/transform-data-at-rest
source: https://tenzir.com/docs/guides/store/transform-data-at-rest.md
section: "Docs"
---
    ...
    time:
      ...
      rules:
        ...
        - after: 7 days
          name: flow_reduction
          pipeline: |
            timestamp = timestamp.floor(10min)
            summarize \
              timestamp,
              src_ip,
              dest_ip,
...
This compaction rule works based on the import time of events. If we want to compact based on timestamps stored in the event instead, we can add an additional `field: timestamp` specifier to the rule above.
