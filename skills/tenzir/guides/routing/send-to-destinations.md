...
Our guide on [Write partitioned files](write-partitioned-files.md) explains how to partition files and rotate them by size or time, including how buffering operators such as `sort` affect rotation.
...
* [Write partitioned files](write-partitioned-files.md)
