...
canonical: https://tenzir.com/docs/reference/api/platform/nodes/node-proxy-put
source: https://tenzir.com/docs/reference/api/platform/nodes/node-proxy-put.md
section: "Docs"
---
...
put`/user/node-proxy/{tenant_id}/{node_id}/{http_path}`
