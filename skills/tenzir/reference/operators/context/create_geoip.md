...
The `context::create_geoip` operator constructs a new context of type [GeoIP](../../../explanations/enrichment.md#geoip-database).

You must either provide a database with the `db_path` argument or use [`context::load`](https://tenzir.com/docs/reference/operators/context/load.md) to populate the context after creation.
