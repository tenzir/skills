---
title: "context_list"
canonical: https://tenzir.com/docs/reference/operators/context_list
source: https://tenzir.com/docs/reference/operators/context_list.md
section: "Docs"
---
...
The `context_list` operator retrieves all contexts.
