...
| ----------------------------------------------------------------- | --------------- | -------------- | ---------- |
| [`csv`](https://tenzir.com/docs/reference/functions/parse_csv.md) | `,`             | `;`            | empty      |
| [`ssv`](https://tenzir.com/docs/reference/functions/parse_ssv.md) | `<space>`       | `,`            | `-`        |
| [`tsv`](https://tenzir.com/docs/reference/functions/parse_tsv.md) | `\t`            | `,`            | `-`        |
