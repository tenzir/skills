...
### `Registry.registry_key` / `Registry.registryKey`
...
### `Registry.registry_value_data` / `Registry.registryValueData`
...
### `Registry.registry_value_name` / `Registry.registryValueName`
