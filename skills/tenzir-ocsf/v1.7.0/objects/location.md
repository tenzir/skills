...
> **Deprecated since v1.2.0.** Use specific `lat, long` attributes instead.
...
> **Deprecated since v1.5.0.** Utilize `isp` attribute available in `network_endpoint, whois` objects according to your use-case.
