...
* **Values**:
  ...
  * `200101` - `Security Finding: Create`: A security finding was created.
  * `200102` - `Security Finding: Update`: A security finding was updated.
  * `200103` - `Security Finding: Close`: A security finding was closed.
