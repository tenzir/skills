...
> The Programmatic Credential object describes service-specific credentials used for direct API access and system integration.
...
The type or category of programmatic credential, normalized to the caption of the type\_id value. In the case of ‘Other’, it is defined by the event source. Examples include ‘API Key’, ‘Service Account Key’, ‘Access Token’, ‘Client Certificate’, ‘OAuth Token’, ‘Personal Access Token’, etc.
