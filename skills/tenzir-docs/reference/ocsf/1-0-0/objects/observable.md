...
* **Values**:
  ...
  * `2` - `IP Address`: Observable by Dictionary Type. Internet Protocol address (IP address), in either IPv4 or IPv6 format.
  ...
  * `8` - `File Hash`: Observable by Dictionary Type. File hash. A unique value that corresponds to the content of the file.
