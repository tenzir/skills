...
The load type, normalized to the caption of the load\_type\_id value. In the case of ‘Other’, it is defined by the event source. It describes how the module was loaded in memory.
