...
> Complete listing of OCSF 1.2.0 objects by category.


Complete listing of objects by category.

## Identity & Access (12 objects)
...
## Security & Compliance (16 objects)
...
* [MITRE ATT\&CK®](objects/attack.md): The [MITRE ATT\&CK®](https://attack.mitre.org) object describes the tactic, technique & sub-technique associated to an attack as defined in ATT\&CK MatrixTM.
...
* [Sub Technique](objects/sub_technique.md): The Sub Technique object describes the sub technique ID and/or name associated to an attack, as defined by ATT\&CK MatrixTM.
...
* [Tactic](objects/tactic.md): The Tactic object describes the tactic ID and/or name that is associated to an attack, as defined by ATT\&CK MatrixTM.
* [Technique](objects/technique.md): The Technique object describes the technique ID and/or name associated to an attack, as defined by ATT\&CK MatrixTM.
