...
* **Values**:
  ...
  * `700401` - `Network Remediation Activity: Isolate`: Creates logical or physical barriers in a system which reduces opportunities for adversaries to create further accesses. Defined by D3FEND™ [d3f:Isolate](https://d3fend.mitre.org/tactic/d3f:Isolate/).
  * `700402` - `Network Remediation Activity: Evict`: Removes an adversary or malicious resource from a device or computer network. Defined by D3FEND™ [d3f:Evict](https://d3fend.mitre.org/tactic/d3f:Evict/).
  * `700403` - `Network Remediation Activity: Restore`: Returns the system to a better state. Defined by D3FEND™ [d3f:Restore](https://d3fend.mitre.org/tactic/d3f:Restore/).
  * `700404` - `Network Remediation Activity: Harden`: Increases the opportunity cost of computer network exploitation. Defined by D3FEND™ [d3f:Harden](https://d3fend.mitre.org/tactic/d3f:Harden/).
  * `700405` - `Network Remediation Activity: Detect`: Further identify adversary access to or unauthorized activity on computer networks. Defined by D3FEND™ [d3f:Detect](https://d3fend.mitre.org/tactic/d3f:Detect/).
