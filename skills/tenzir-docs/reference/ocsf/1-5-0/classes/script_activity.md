...
* **Requirement**: required
* **Values**:
  * `1009` - `Script Activity`: Script Activity events report when a process executes a script.
...
The event class name, as defined by class\_uid value: `Script Activity`.
