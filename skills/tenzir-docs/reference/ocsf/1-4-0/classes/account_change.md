...
* **Values**:
  ...
  * `300110` - `Account Change: MFA Factor Enable`: An authentication factor was enabled for an account.
  * `300111` - `Account Change: MFA Factor Disable`: An authentication factor was disabled for an account.
