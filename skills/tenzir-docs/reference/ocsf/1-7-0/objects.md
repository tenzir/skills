...
> Complete listing of OCSF 1.7.0 objects by category.
...
* [Authentication Token](objects/authentication_token.md): The Authentication Token object represents standardized authentication tokens, tickets, or assertions that conform to established authentication protocols such as Kerberos, OIDC, and SAML.
...
* [Module](objects/module.md): The Module object describes the attributes of a module.
...
* [Peripheral Device](objects/peripheral_device.md): The peripheral device object describes the properties of external, connectable, and detachable hardware.
...
* [Network Traffic](objects/network_traffic.md): The Network Traffic object describes characteristics of network traffic over a time period.
...
* [Encryption Details](objects/encryption_details.md): Details about the encryption methodology utilized.
...
* [Cloud](objects/cloud.md): The Cloud object describes the cloud computing environment where an event or finding originated.
* [Function Invocation](objects/function_invocation.md): The Function Invocation object provides details regarding the invocation of a function.
...
* [Reporter](objects/reporter.md): The entity from which an event or finding was reported.
...
* [Identity Activity Metrics](objects/identity_activity_metrics.md): The Identity Activity Metrics object captures usage patterns, authentication activity, credential usage and other metrics for identities across cloud and on-premises environments.
...
* [Access Analysis Result](objects/access_analysis_result.md): The Access Analysis Result object describes access relationships and pathways between identities, resources, focusing on who can access what and through which mechanisms.
* [Additional Restriction](objects/additional_restriction.md): The Additional Restriction object describes supplementary access controls and guardrails that constrain or limit granted permissions beyond the primary policy.
...
* [Parameter](objects/parameter.md): The Parameter object provides details regarding a parameter of a a function.
* [Permission Analysis Result](objects/permission_analysis_result.md): The Permission Analysis object describes analysis results of permissions, policies directly associated with an identity (user, role, or service account).
* [Port Information](objects/port_info.md): The Port Information object describes a port and its associated protocol details.
* [Programmatic Credential](objects/programmatic_credential.md): The Programmatic Credential object describes service-specific credentials used for direct API access and system integration.
