...
> The Application Security Posture Finding event is a notification about any bug, defect, deficiency, exploit, vulnerability, weakness or any other issue with software and related systems.
...
* **Values**:
  ...
  * `200701` - `Application Security Posture Finding: Create`: A finding was created.
  * `200702` - `Application Security Posture Finding: Update`: A finding was updated.
  * `200703` - `Application Security Posture Finding: Close`: A finding was closed.
...
The event class name, as defined by class\_uid value: `Application Security Posture Finding`.
