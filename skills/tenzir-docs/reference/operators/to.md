...
The format to write inferred from the file-ending. Supported file formats are the common file endings for our [`read_*` operators](/reference/operators.md#parsing).
...
The compression, just as the format, is inferred from the “file-ending” in the URI. Under the hood, this uses the [`decompress_*` operators](/reference/operators.md#encode--decode). Supported compressions can be found in the [list of compression extensions](#compression).
...
| `file`                             | [`save_file`](/reference/operators/save_file.md)                             | `to "file://path/to/file.json"`                |
| `fluent-bit`                       | [`to_fluent_bit`](/reference/operators/to_fluent_bit.md)                     | `to "fluent-bit://elasticsearch"`              |
| `ftp`, `ftps`                      | [`save_ftp`](/reference/operators/save_ftp.md)                               | `to "ftp://example.com/file.json"`             |
| `gs`                               | [`save_gcs`](/reference/operators/save_gcs.md)                               | `to "gs://bucket/object.json"`                 |
| `http`, `https`                    | [`save_http`](/reference/operators/save_http.md)                             | `to "http://example.com/file.json"`            |
| `inproc`                           | [`save_zmq`](/reference/operators/save_zmq.md)                               | `to "inproc://127.0.0.1:56789" { write_json }` |
| `kafka`                            | [`save_kafka`](/reference/operators/save_kafka.md)                           | `to "kafka://topic" { write_json }`            |
| `opensearch`                       | [`to_opensearch`](/reference/operators/to_opensearch.md)                     | `to "opensearch://…`                           |
| `s3`                               | [`save_s3`](/reference/operators/save_s3.md)                                 | `to "s3://bucket/file.json"`                   |
| `sqs`                              | [`save_sqs`](/reference/operators/save_sqs.md)                               | `to "sqs://my-queue" { write_json }`           |
| `tcp`                              | [`save_tcp`](/reference/operators/save_tcp.md)                               | `to "tcp://127.0.0.1:56789" { write_json }`    |
| `udp`                              | [`save_udp`](/reference/operators/save_udp.md)                               | `to "udp://127.0.0.1:56789" { write_json }`    |
| `zmq`                              | [`save_zmq`](/reference/operators/save_zmq.md)                               | `to "zmq://127.0.0.1:56789" { write_json }`    |
| `smtp`, `smtps`, `mailto`, `email` | [`save_email`](/reference/operators/save_email.md)                           | `to "smtp://john@example.com"`                 |
...
| NDJSON  | `.ndjson`, `.jsonl`  | [`write_ndjson`](/reference/operators/write_ndjson.md)   |
| Parquet | `.parquet`           | [`write_parquet`](/reference/operators/write_parquet.md) |
| Pcap    | `.pcap`              | [`write_pcap`](/reference/operators/write_pcap.md)       |
| SSV     | `.ssv`               | [`write_ssv`](/reference/operators/write_ssv.md)         |
| TSV     | `.tsv`               | [`write_tsv`](/reference/operators/write_tsv.md)         |
| YAML    | `.yaml`              | [`write_yaml`](/reference/operators/write_yaml.md)       |
