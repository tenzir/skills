...
Sample some `metrics` every hour, limiting the max samples per period to 5,000 samples (`max_samples`) and limiting the overall sample count to 100,000 samples ([`head`](http://docs.tenzir.com/reference/operators/head.md)).
...
* [`deduplicate`](http://docs.tenzir.com/reference/operators/deduplicate.md)
