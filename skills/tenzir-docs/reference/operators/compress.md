...
The `compress` operator is deprecated. You should use the [bespoke operators](../operators.md#encode--decode) instead. These operators offer more options for some of the formats.
