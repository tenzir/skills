...
You must either provide a database with the `db_path` argument or use [`context::load`](http://docs.tenzir.com/reference/operators/context/load.md) to populate the context after creation.
