...
The `from_sentinelone_data_lake` operator queries the [SentinelOne Data Lake PowerQuery API](https://support.sentinelone.com/hc/en-us/articles/360004195934-SentinelOne-API-Guide) to retrieve security events based on a custom query.
