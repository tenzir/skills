...
You can output events to Fluent Bit using the [`to_fluent_bit`](https://tenzir.com/docs/reference/operators/to_fluent_bit.md) operator.
...
Use `from_fluent_bit` directly to receive events from Fluent Bit:
