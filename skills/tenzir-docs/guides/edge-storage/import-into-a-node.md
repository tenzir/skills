...
The [`import`](http://docs.tenzir.com/reference/operators/import.md) operator requires a running node. To run the above pipeline successfully, you need to first [setup a node](../node-setup/provision-a-node.md).
