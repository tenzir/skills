...
Feb 10, 2026 · [@mavam](https://github.com/mavam), [@claude](https://github.com/claude) · [#17](https://github.com/tenzir/test/pull/17)
...
[ Download on GitHub ](https://github.com/tenzir/test/releases/tag/v1.3.0)

[Get the release artifacts and source code.](https://github.com/tenzir/test/releases/tag/v1.3.0)