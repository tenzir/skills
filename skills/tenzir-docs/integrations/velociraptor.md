...
2. Create an API client:
   ...
   Copy the generated `client.yaml` to your Tenzir [plugin configuration](../reference/node/configuration.md) directory as `velociraptor.yaml` so that the operator can find it:
