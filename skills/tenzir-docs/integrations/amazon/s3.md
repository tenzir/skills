...
Use [`from_s3`](http://docs.tenzir.com/reference/operators/from_s3.md) to read files from S3. It supports glob patterns, automatic format detection, and IAM role assumption. For writing, use [`to_s3`](http://docs.tenzir.com/reference/operators/to_s3.md) with a print operator.
