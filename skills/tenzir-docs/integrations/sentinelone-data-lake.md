...
Use the [`from_sentinelone_data_lake`](http://docs.tenzir.com/reference/operators/from_sentinelone_data_lake.md) operator to retrieve security events from the Data Lake using PowerQuery:
