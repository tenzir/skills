...
For Microsoft Defender and Microsoft 365 data that is exposed as Microsoft Graph collections, use [Microsoft Graph](graph.md) with [`from_microsoft_graph`](/reference/operators/from_microsoft_graph.md). Use Azure Event Hubs for real-time Defender streaming. For the Microsoft API surface, see the [Microsoft Graph Security API reference](https://learn.microsoft.com/en-us/graph/api/resources/security-api-overview) and the [Microsoft Defender XDR API reference](https://learn.microsoft.com/en-us/defender-xdr/api-overview).
